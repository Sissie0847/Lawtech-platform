    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .key-data-card {
            ...
            align-items: center;
            gap: 6px;
            background: linear-gradient(135deg, rgba(72,156,193,0.08) 0%, rgba(108,99,255,0.06) 100%);
            border-radius: 20px;
            padding: 6px 14px;
            border: 1px solid rgba(72,156,193,0.15);
        }
        .key-data-label {
            font-size: 0.75rem;
        ...
        <section class="lead-story">
            ...
            <div class="key-data-container">
                ...
                <div class="key-data-card">
                    ...
                    <span class="key-data-value">{{ item.value }}</span>
                    {% if item.unit %}<span class="key-data-unit">{{ item.unit }}</span>{% endif %}
                </div>
                {% endfor %}
            </div>
            {% endif %}
